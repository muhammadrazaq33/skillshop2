...
const GoogleSlidesHero = () => {
  return (
    <div>
      <div>
        {/* image */}
        <img src="./assets/slide1.png" className="w-full" alt="" />
        ...
        <div className="sm:mt-[2.5rem] mt-[1.5rem] max-w-[680px] w-[92vw] m-auto ">
          ...
          <div className=" flex flex-col gap-2.5 py-6 border-b border-gray-400">
            <h1 className="Heading leading-[2.9rem]">
              Deliver interactive presentations with Google Slides
            </h1>
          ...
          <div className="mt-3 flex flex-col gap-10">
            ...
            <p className="text-[19px] text-[#393b3d]">
              Enhance your classroom experience with interactive lessons with
              features from Google Slides.
            </p>
          </div>
        </div>
      </div>
...
export default GoogleSlidesHero;
