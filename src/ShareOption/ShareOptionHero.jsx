...
const ShareOptionHero = () => {
  return (
    <div>
      <div>
        {/* image */}
        <img src="./assets/share1.png" className="w-full" alt="" />
        ...
        <div className="sm:mt-[2.5rem] mt-[1.5rem] max-w-[680px] w-[92vw] m-auto ">
          ...
          <div className=" flex flex-col gap-2.5 py-6 border-b border-gray-400">
            <h1 className="Heading leading-[2.9rem]">
              Share personalization options using Google Workspace for Education
            </h1>
          ...
          <div className="mt-3 flex flex-col gap-10">
            ...
            <p className="text-[19px] text-[#393b3d]">
              Explore how Google Workspace for Education can enhance
              project-based, blended and flipped learning for a personalized
              learning experience.
            </p>
          </div>
        </div>
...
export default ShareOptionHero;
