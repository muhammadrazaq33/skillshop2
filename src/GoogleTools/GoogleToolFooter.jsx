            ...
            <div className="table-container px-6 pt-10 pb-6 flex flex-col gap-5">
              <div className="flex flex-col gap-5">
                <h1 className="text-[20px]">
                  A colleague wants to make the process of updating information
                  about students’ academic and behavioral progress more
                  efficient. They want to use dropdown menus rather than having
                  to type everything.
                </h1>
                <h1 className="text-[20px]">
                  Which Google Sheets tool would you recommend to your peer to
              ...
              <div className="grid sm:grid-cols-2 grid-cols-1 gap-1">
                <article className="flex items-center gap-4 border-[#e37400] border-[2px] py-4 px-5 rounded-md hover:bg-[#e37400] hover:text-white">
                  <input
                    ...
                    id=""
                  />
                  <p className="text-[16px] font-medium">Comments</p>
                </article>
                <article className="flex items-center gap-4 border-[#e37400] border-[2px] py-4 px-5  rounded-md hover:bg-[#e37400] hover:text-white">
                  <input
                    type="checkbox"
                    ...
                    id=""
                  />
                  <p className="text-[16px] font-medium">Data validation</p>
                </article>
                <article className="flex items-center gap-4 border-[#e37400] border-[2px] py-4 px-5  rounded-md hover:bg-[#e37400] hover:text-white">
                  <input
                    type="checkbox"
                    ...
                    id=""
                  />
                  <p className="text-[16px] font-medium">Filtering</p>
                </article>
                <article className="flex items-center gap-4 border-[#e37400] border-[2px] py-4 px-5  rounded-md hover:bg-[#e37400] hover:text-white">
                  <input
                    type="checkbox"
                    ...
                    id=""
                  />
                  <p className="text-[16px] font-medium">Sorting</p>
                </article>
              </div>
...
export default GoogleToolFooter;
