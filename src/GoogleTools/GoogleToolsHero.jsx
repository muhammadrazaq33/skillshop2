...
const GoogleToolsHero = () => {
  return (
    <div>
      <div>
        {/* image */}
        <img src="./assets/tool1.png" className="w-full" alt="" />
        ...
        <div className="sm:mt-[2.5rem] mt-[1.5rem] max-w-[680px] w-[92vw] m-auto ">
          ...
          <div className="mt-3 flex flex-col gap-10">
            ...
            <p className="text-[19px] text-[#393b3d]">
              Connect with your guardians and students more effectively with
              automation and personalized updates. Use Google tools to summarize
              information and track student progress.
            </p>
          </div>
        </div>
      </div>
...
export default GoogleToolsHero;
