...
const DigitalPortfolioHero = () => {
  return (
    <div>
      <div>
        {/* image */}
        <img src="./assets/portfolio.png" className="w-full" alt="" />
        ...
        <div className="sm:mt-[2.5rem] mt-[1.5rem] max-w-[680px] w-[92vw] m-auto ">
          ...
          <div className="mt-3 flex flex-col gap-10">
            ...
            <p className="text-[19px] text-[#393b3d]">
              Host your students work in one consolidated place on Google Sites
              and Drive. Assess and manage their projects and provide space for
              your students to reflect on their learning beyond the classroom.
            </p>
          </div>
        </div>
      </div>
...
export default DigitalPortfolioHero;
