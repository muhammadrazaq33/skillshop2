...
const GuardianInfoHero = () => {
  return (
    <div>
      <div>
        {/* image */}
        <img src="./assets/guardian1.png" className="w-full" alt="" />
        ...
        <div className="sm:mt-[2.5rem] mt-[1.5rem] max-w-[680px] w-[92vw] m-auto ">
          ...
          <div className="mt-3 flex flex-col gap-10">
            ...
            <p className="text-[19px] text-[#393b3d]">
              Build your relationship with your guardians by enhancing your
              communication with Google Forms.
            </p>
          </div>
        </div>
      </div>
...
export default GuardianInfoHero;
