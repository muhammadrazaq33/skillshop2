          ...
          <div className="table-container px-6 pt-10 pb-6 flex flex-col gap-5">
            <div className=" flex flex-col gap-5">
              <h1 className="text-[20px]">
                At the start of the school year, you need to collect guardian
                contact information and their volunteer availability for
                upcoming school events.
              </h1>
              <h1 className="text-[20px]">
                Which tool could you use to create a survey to gather this
                information?
              </h1>
            </div>
            ...
            <div className="grid sm:grid-cols-2 grid-cols-1 gap-1">
              <article className="flex items-center gap-4 border-[#e37400] border-[2px] py-4 px-5 rounded-md hover:bg-[#e37400] hover:text-white">
                <input
                  ...
                  id=""
                />
                <p className="text-[16px] font-medium">Google Classroom</p>
              </article>
              <article className="flex items-center gap-4 border-[#e37400] border-[2px] py-4 px-5  rounded-md hover:bg-[#e37400] hover:text-white">
                <input
                  type="checkbox"
                  ...
                  id=""
                />
                <p className="text-[16px] font-medium">Google Forms</p>
              </article>
              <article className="flex items-center gap-4 border-[#e37400] border-[2px] py-4 px-5  rounded-md hover:bg-[#e37400] hover:text-white">
                <input
                  type="checkbox"
                  ...
                  id=""
                />
                <p className="text-[16px] font-medium">Google Calendar</p>
              </article>
              <article className="flex items-center gap-4 border-[#e37400] border-[2px] py-4 px-5  rounded-md hover:bg-[#e37400] hover:text-white">
                <input
                  type="checkbox"
                  ...
                  id=""
                />
                <p className="text-[16px] font-medium">Google Meet</p>
              </article>
            </div>
      ...
      <div className="pt-16 pb-24 bg-[#3C4043] grid place-items-center">
        <div className="grid place-items-center gap-y-3">
          ...
          <p className="text-white">
            It looks like you've completed this module.
          </p>
        </div>
      </div>
      {/*end of last footer */}
