            ...
            <div className="table-container px-6 pt-10 pb-6 flex flex-col gap-5">
              <div className=" flex flex-col gap-5">
                <h1 className="text-[20px]">
                  Which <strong>one</strong> of the following is a Google Earth
                  feature that allows you to watch timelapse animations, take
                  interactive quizzes, and explore data layers on a 3D model of
                  the globe?
                </h1>
              </div>
              ...
              <div className="grid sm:grid-cols-2 grid-cols-1 gap-1">
                ...
                <article className="flex items-center gap-4 border-[#e37400] border-[2px] py-4 px-5  rounded-md hover:bg-[#e37400] hover:text-white">
                  <input
                    ...
                    id=""
                  />
                  <p className="text-[16px] font-medium">Voyager</p>
                </article>
                <article className="flex items-center gap-4 border-[#e37400] border-[2px] py-4 px-5  rounded-md hover:bg-[#e37400] hover:text-white">
                  <input
                    type="checkbox"
                    ...
                    id=""
                  />
                  <p className="text-[16px] font-medium">My Maps</p>
                </article>
                <article className="flex items-center gap-4 border-[#e37400] border-[2px] py-4 px-5  rounded-md hover:bg-[#e37400] hover:text-white">
                  <input
                    type="checkbox"
                    ...
                    id=""
                  />
                  <p className="text-[16px] font-medium">Street View</p>
                </article>
              </div>
...
export default GoogleMeetFooter;
